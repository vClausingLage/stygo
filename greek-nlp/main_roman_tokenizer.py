...
with open("tokenizer/input-roman.json", "r") as f:
  text = f.read()
  text = json.loads(text)

longos = text_preparer.text_preparer(text["text"])
...
with open("output/normalizedRomanText.txt", "w") as f:
  data = [
    {"author": text["author"], "normalized text": longos}#,
...
nice_subst = [("χαρις", "χάριτος", "f"), ("δῶρον", "δώρου", "n"), ("σεβας", "σέβατος", "n"), ("ἄκος", "ἄκεος", "n"), ("θέλκτωρ", "θέλκτορος", "m")]; nice_adj = [("καλός", "καλοῦ", "adj"), ("ἀγαθος", "ἀγαθου", "adj"), ("προξένος", "προξένου", "adj"), ("φιλόξενος", "φιλόξενου", "adj"), ("βέλτερος", "βέλτερου", "adj")]
...
text_total = authors[0]["normalized text"]
def word_count(text):
  counts = dict()
  words = text.split()
  for word in words:
...
print("writing file...")
with open("output/wordCountRoman.txt", "w") as f:
...
print("writing file...")
with open("output/resultRomanData.json", "w") as f:
