...
angry_subst = [("φόβος", "φόβου"), ("φόνος", "φόνου"), ("κότος", "κότου"), ("δεῖμα", "δείματος", "n"), ("αἷμα", "αιματος", "n"), ("πόλεμος", "πολέμου"), ("βλάβη", "βλάβης"), ("ὀργή", "ὀργῆς"), ("αἰσχύνη", "αἰσχύνης"), ("βία", "βίας"), ("θάνατος", "θανάτου")] ; angry_adj = [("στυγερός", "στυγεροῦ", "adj"), ("ἐχθρός", "ἐχθροῦ", "adj")]
nasty_subst = [("δόλος", "δόλου"), ("ψόγος", "ψόγου"), ("πόνος", "πόνου"), ("ἀνάγκη", "ἀνάγκης"), ("συμφορά", "συμφορᾶς"), ("καταισχύνη", "καταισχύνης"), ("πόνος", "πόνου"), ("ἄλγος", "ἄλγους", "att"), ("αἶσχος", "αἴσχους", "att")]; nasty_adj = [("κακός", "κακοῦ", "adj"), ("αἰσχρός", "αἰσχροῦ", "adj") , ("ἄτιμος", "ἀτίμου", "adj"), ("τάλας", "τάλαντος", "n"), ("τάλαινα", "ταλαίνης", "adj"), ("δεινός", "δεινοῦ", "adj")]
affectionate_subst = [("φίλημα", "φιλήματος", "n"), ("γάμος", "γάμου"), ("σωτήρ", "σωτήρος", "m"), ("κοίτη", "κοίτης")]; affectionate_adj = [("γαμήλιος", "γαμηλίου", "adj"), ("φίλος", "φίλου", "adj")]
nice_subst = [("χάρις", "χάριτος", "f"), ("δῶρον", "δώρου", "n"), ("σεβας", "σέβατος", "n"), ("ἄκος", "ἄκεος", "n"), ("θέλκτωρ", "θέλκτορος", "m")]; nice_adj = [("καλός", "καλοῦ", "adj"), ("ἀγαθός", "ἀγαθοῦ", "adj"), ("πρόξενος", "προξένου", "adj"), ("φιλόξενος", "φιλόξενου", "adj"), ("βέλτερος", "βέλτερου", "adj")]
